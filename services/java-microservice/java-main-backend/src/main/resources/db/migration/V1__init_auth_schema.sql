-- ============================================================
-- AssetFlow ERP - Unified initial schema (Authentication + Organization setup)
-- PostgreSQL. Single V1 that satisfies BOTH the auth module and the
-- admin/organisationsetup module.
-- ============================================================
...
-- ------------------------------------------------------------
-- Enum types. Dropped first so a fresh, complete definition is created
-- (a prior run may have left an account_status without 'REJECTED').
-- Safe: this migration runs on an empty schema, so nothing depends on them.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- audit_logs (organization setup module)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Uniqueness (per-organization) and lookup indexes
-- ------------------------------------------------------------
